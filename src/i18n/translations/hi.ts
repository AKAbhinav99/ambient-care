...
export const hi: Messages = {
  ...
  codeEntry: {
    title: 'अपना कोड डालें',
    sub: 'आपके परिवार ने इस डिवाइस के लिए एक कोड बनाया है। शुरू करने के लिए उसे टाइप करें।',
    placeholder: 'ABC123',
    connect: 'कनेक्ट करें',
    connecting: 'कनेक्ट हो रहा है…',
    invalid: 'यह कोड मेल नहीं खाया। कृपया जाँचें और फिर कोशिश करें।',
    back: 'वापस जाएँ',
  },
